...
export function Homepage(){
    return(
        ...
        <nav className="navbar navbar-expand-lg navbar-light bgset ">
...
<div className='row'> 
                 ...
                 <div className='col-lg-6'> 
                     ...
                     <button className='digbut p-3 pl-3 pr-3'><b>Digitize Now</b></button>
                </div> 
                ...
                <div className='col-lg-8'>
                  <img src={Variant2} className='col-lg-12 '/> 
